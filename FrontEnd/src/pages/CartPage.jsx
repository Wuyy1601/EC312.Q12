                      ...
                      {item.customization && (
                        <div className="cart-customization">
                          {item.customization.subscription === 'monthly' && (
                             <div className="cart-sub-badge">
                               <i className="fa-solid fa-rotate-right" /> Đăng ký định kỳ
                             </div>
                          )}
                          ...
                          {item.customization.image && (
                            <div className="cart-custom-img">
                              <img src={item.customization.image} alt="Custom" />
                            </div>
                          )}
                        </div>
                      )}
